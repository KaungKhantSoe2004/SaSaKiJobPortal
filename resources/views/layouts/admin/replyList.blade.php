       ...
       <div class="table-data__tool">
        <div class="table-data__tool-left">
            <div class="overview-wrap">
                <h2 class="title-1">Reply List</h2>
        ...
        <div class="table-data__tool-right">
            ...
            <a href="{{route('admin#contactList')}}" class="au-btn au-btn-icon au-btn--green au-btn--small">
                <i class="zmdi zmdi-arrow-right"></i> Messages
            </a>
            <div class=" mt-4 d-block">
                <form action="{{route('admin#mailList')}}" method="get"  class="  d-flex">
             ...
             <tr class="tr-shadow">
                ...
                <td>
                    <div class="table-data-feature">
                       ...
                       <a href="{{route('admin#replyDelete',[$mail->id])}}" class="item" data-toggle="tooltip" data-placement="top" title="Delete">
